...
abstract class WordRoomDatabase: RoomDatabase() {
    ...
    private class WordDatabaseCallback(
        ...
        suspend fun populateDatabase(wordDao: WordDao) {
            ...
            var word: Word
            word = Word("Palabra001")
            wordDao.insert(word)
            word = Word("Palabra002")
            wordDao.insert(word)
            word = Word("Palabra003")
            wordDao.insert(word)
            word = Word("Palabra004")
            wordDao.insert(word)
            word = Word("Palabra005")
            wordDao.insert(word)
            word = Word("Palabra006")
            wordDao.insert(word)
            word = Word("Palabra007")
            wordDao.insert(word)
            word = Word("Palabra008")
            wordDao.insert(word)
            word = Word("Palabra009")
            wordDao.insert(word)
            word = Word("Palabra010")
            wordDao.insert(word)
            word = Word("Palabra011")
            wordDao.insert(word)
            word = Word("Palabra012")
            wordDao.insert(word)
            word = Word("Palabra013")
            wordDao.insert(word)
            word = Word("Palabra014")
            wordDao.insert(word)
            word = Word("Palabra015")
            wordDao.insert(word)
            word = Word("Palabra016")
            wordDao.insert(word)
            word = Word("Palabra017")
            wordDao.insert(word)
            word = Word("Palabra018")
            wordDao.insert(word)
            word = Word("Palabra019")
            wordDao.insert(word)
            word = Word("Palabra020")
            wordDao.insert(word)
